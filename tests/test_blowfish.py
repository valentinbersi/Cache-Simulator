...
class TestBlowfish():
    ...
    def test_blowfish_4096_4_16_summary(self):
        args = ['./cachesim','./cacheTraces/blowfish.xex','4096','4','16']
    ...
    def test_blowfish_4096_1_256(self):
        args = ['./cachesim','./cacheTraces/blowfish.xex','4096','1','256','-v','0','10000']
    ...
    def test_blowfish_4096_4_16(self):
        args = ['./cachesim','./cacheTraces/blowfish.xex','1024','2','32','-v','0','15000']
