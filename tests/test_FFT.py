...
class TestFFT():
    ...
    def test_fft_1024_4_32_summary(self):
        args = ['./cachesim','./cacheTraces/FFT.xex','1024','4','32']
    ...
    def test_fft_1024_4_32(self):
        args = ['./cachesim','./cacheTraces/FFT.xex','1024','4','32','-v','0','15000']
    ...
    def test_fft_8192(self):
        args = ['./cachesim','./cacheTraces/FFT.xex','8192','1','256','-v','0','10000']
