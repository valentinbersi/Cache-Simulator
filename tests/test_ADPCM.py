...
class TestADPCM():
    ...
    def test_adpcm_2048_2_64_summary(self):
        args = ['./cachesim','./cacheTraces/adpcm.xex','2048','2','64']
    ...
    def test_adpcm_2048_2_64(self):
        args = ['./cachesim','./cacheTraces/adpcm.xex','2048','2','64','-v','0','15000']
    ...
    def test_adpcm_4096(self):
        args = ['./cachesim','./cacheTraces/adpcm.xex','4096','1','256','-v','0','10000']
